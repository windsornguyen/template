...
# shard_size = int(1.3e7)  # 100M tokens per shard
...
# fw = load_dataset("billion-word-benchmark/lm1b", split="train")
...
#             filename = os.path.join(DATA_CACHE_DIR, f"lm1b_{split}_{shard_idx:06d}")
